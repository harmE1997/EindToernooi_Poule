...
namespace EindToernooi_Poule.Code
{
    ...
    public class BonusQuestions
    {
        ...
        public BonusQuestions(string[] answers)
        {
            ...
            {
                {BonusKeys.Kampioen, new Question(){Answer = new string[] {answers[0] }, Points = 360 } },
                {BonusKeys.Topscorer, new Question(){Answer = new string[] {answers[1] }, Points = 25} },
                {BonusKeys.Nederland, new Question(){Answer = new string[] {answers[2] }, Points = 80 } },
                {BonusKeys.Bronze, new Question(){Answer = new string[] {answers[3] }, Points = 160 } },
            };
        }
